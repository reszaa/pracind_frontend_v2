...
const bukaUploadKosong = () => {
    // Upload lepas: user isi nomor PO sendiri (dipakai jarang; jalur utama
    // lewat tombol Upload di baris yang sudah tahu PO-nya).
...
.baris {
    display: grid;
    grid-template-columns: minmax(9rem, 1.1fr) minmax(0, 2.4fr) auto auto auto;
    gap: 1rem;
    align-items: center;
