...
export const TRANSAKSI = [
    ...
    },
    {
        ...
        // Backend sales_order belum punya urls.py maupun service, dan
        // SalesOrder belum punya sisi pembayaran. Lihat PRD §4.
        siap: false,
        catatan: 'Menunggu modul Sales Order di backend',
    },
    {
        id: 'pembayaran',
        label: 'Pembayaran',
