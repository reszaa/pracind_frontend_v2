<!--
  src/features/warehouse/layout/WarehouseLayout.vue
  =================================================
  Ruang Kerja Gudang — Inbound, Outbound, Opname, dan Stok.
-->
<template>
    <div class="flex h-screen bg-[#F8FAFC] font-sans text-slate-700 overflow-hidden relative">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="font-bold text-slate-800 text-base md:text-lg">Operasi Gudang</span>
            </div>
...
import { useNavWarehouse } from '@/features/warehouse/composables/useNavWarehouse'

const route = useRoute()
const router = useRouter()
const { logout } = useAuth()
const { sidebarAktif, isMobile, toggleSidebar, tutupDiMobile } = useLayout()
const { menu, aktif } = useNavWarehouse()
